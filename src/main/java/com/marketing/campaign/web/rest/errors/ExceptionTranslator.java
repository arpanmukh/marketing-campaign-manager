package com.marketing.campaign.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.marketing.campaign.service.EmailAlreadyUsedException ||
            ex instanceof com.marketing.campaign.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.marketing.campaign.service.InvalidPasswordException
